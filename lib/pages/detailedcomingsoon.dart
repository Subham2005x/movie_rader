...
class _DetailedcomingsoonState extends State<Detailedcomingsoon> {
  ...
  @override
  void didUpdateWidget(Detailedcomingsoon oldWidget) {
                                              ...
                                              (
                                                ...
                                                return InkWell(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text(
                                                        "${movieDetails['genres'][index]['name'] ?? 'Unknown'}",
                                                        style: TextStyle(
                                                          color: Colors.white,
                                                          fontSize: 16,
                                                        ),
                                ...
                                return Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4),
                                      Text(
                                        "${movieCredits['cast'][index]['name'] ?? 'Unknown'}",
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                        ),
                                      ...
                                      Text(
                                        "${movieCredits['cast'][index]['character'] ?? movieCredits['cast'][index]['known_for_department'] ?? 'Actor'}",
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: Colors.grey,
                                        ),
